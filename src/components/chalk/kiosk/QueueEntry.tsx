  ...
  return (
    ...
    >
      <div className="flex items-center gap-[1.1vmin]">
        ...
        >
          <span className={!isCalled && !isOnHold ? 'text-white/70' : undefined}>{position}</span>
        </span>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-[0.75vmin]">
            ...
            {entry.gameMode !== 'singles' && (
              <span className="px-[0.55vmin] py-[0.2vmin] rounded text-[1.1vmin] bg-surface-elevated text-white/65">
            ...
            <>
              {isOnHold ? (
                ...
                <button
                  ...
                  className="chalk-touch p-[0.75vmin] rounded-[0.7vmin] text-white/50 hover:text-accent hover:bg-accent/10 transition-colors"
